...
namespace Arebis.Core.Services.Interfaces
{
    ...
    public interface ITranslationService
    {
        ...
        /// <param name="settings">Additional settings specific to the translation service.</param>
        ...
        Task<IEnumerable<string?>> TranslateAsync(string fromLanguage, string toLanguage, string mimeType, IEnumerable<string> sources, IDictionary<string, string?>? settings = null, CancellationToken ct = default);
        ...
        Task<IEnumerable<string?>> TranslateAsync(string fromLanguage, IEnumerable<string> toLanguages, string mimeType, string source, IDictionary<string, string?>? settings = null, CancellationToken ct = default);
    }
}
